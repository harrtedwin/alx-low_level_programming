...
Project done during **Full Stack Software Engineering studies** at **AFRICA LEADERSHIP X (ALX)**. It aims to learn about dynamic and shared libraries in **C language**.
